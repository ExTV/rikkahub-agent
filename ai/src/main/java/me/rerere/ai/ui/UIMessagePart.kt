...
sealed class UIMessagePart {
    ...
    data class Tool(
        ...
        val approvalState: ToolApprovalState = ToolApprovalState.Auto,
        /**
         * Unix-millisecond timestamp recorded immediately before tool execution starts.
         * A non-null value with no output marks an interrupted attempt after process death.
         */
        ...
        /** Whether execution started but did not produce a result. */
